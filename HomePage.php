...
<body>
    <div class="">
        <div class="content">
            ...
            <h4>
                <a href="user-create.php" class="btn">Log out</a>
            </h4>
            <table class="">
                <thead>
                    <tr>
                    ...
                    if (mysqli_num_rows($query_run) > 0) {
                        foreach ($query_run as $user) {
                            ...
                            <form action="" method="POST" class="form-flex">
                                ...
                                <!-- <button type="submit" name="book" value="<?= $user['doctor_id']; ?>" class="btn">Book
                                                                                    Appointment</button> -->
                                <a href="./login/userRegister.php" class="btn">Book Appointment</a></p>
                            </form>
                            <?php
                        }
                    } else {
